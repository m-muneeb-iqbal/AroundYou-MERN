...
const FriendListPopup = ({ onClose, onOpenMessages }) => {
    ...
    return (
        ...
        <Card
            border="light"
            className="position-fixed d-flex flex-column shadow"
            style={{
                bottom: "20px",
                right: "20px",
                            ...
                            >
                                ...
                                <div className="flex-grow-1 overflow-hidden">
                                    <div
                                        ...
                                        style={{ fontSize: "0.85rem", color: "#04263D" }}
                                    >
                                        {friend.fullName}
                                    </div>
                                    {friend.designation && (
                                ...
                                {confirmUnfriendId === friend._id ? (
                                    ...
                                    <div className="d-flex gap-1 flex-shrink-0">
                                        <button
                                            ...
                                            onClick={() => handleUnfriendConfirm(friend._id)}
                                        >
                                            Confirm
                                        </button>
                                        <button
                                    ...
                                    <ActionButton
                                        color="#DC3545"
                                        hoverColor="#B02A37"
                                        onClick={() => setConfirmUnfriendId(friend._id)}
                                        title="Unfriend"
                                        size={32}
                                    >
