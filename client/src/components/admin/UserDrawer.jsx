...
import { X, Trash2, UserRoundMinus, BookOpen, Briefcase, Wrench, ImageOff } from "lucide-react";
...
const SectionHeader = ({ label }) => (
    <div
        ...
        style={{ fontSize: "0.78rem", color: "#898C8F", borderBottom: "1px solid #f0f0f0", textTransform: "uppercase", letterSpacing: "0.05em" }}
    >
        {label}
    </div>
);
